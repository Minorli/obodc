# Metadata Runtime Specification

## Purpose
The metadata runtime governs how ODC browses, searches, and synchronizes database objects at production scale.

At large deployment sizes, the runtime must favor:

- bounded responses
- search-first interaction
- background synchronization quotas
- no request-path heavy refresh
